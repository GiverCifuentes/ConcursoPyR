...
document.addEventListener('DOMContentLoaded', function(event){
    ...
    for (let item of datosHistoricos) {
            let total = parseInt(item.Puntoscategoria1) +
                        parseInt(item.Puntoscategoria2) +
                        parseInt(item.Puntoscategoria3) +
                        parseInt(item.Puntoscategoria4) +
                        parseInt(item.Puntoscategoria5);
